...
exports.gogameTurnMode = void 0;
const crypto_1 = __importDefault(require("crypto")); // Import the crypto module for generating random UUIDs
 ...
 * @param container
 */
const gogameTurnMode = (io, socket, usersCosmos, gameInfos, lock, container) => {
    //待機ルームに入る用
    socket.on('gogameTurnMode', function (data) {
        ...
        //ゲームに必要な情報を作成する
        //盤面の正解の情報,現在の盤面の状態
        gameInfos[roomId] = (0, gameLogic_1.generateStartGameInfo)(cl0.data, cl1.data, 'TurnMode');
                ...
                if (gameInfos[roomId]['countdown'] < 0) { //0より小さくなったら、次の人のターンに遷移するという一連の処理
                    ...
                    if (gameInfos[roomId]['turnArray'][gameInfos[roomId]['turnIndex']] === 'auto') {
                        ...
                        if (gameInfos[roomId]['submitFlag']) {
                            ...
                            (0, gameLogic_1.emitStateAllRoomMember)(roomId, io, gameInfos);
                        }
                    }
                    else {
...
exports.gogameTurnMode = gogameTurnMode;
//# sourceMappingURL=turnmode.js.map