...
import { Board, ReturnState, GameInfo, RoomDictionaryArray, GoGameData, SubmitInfo, SubmitExtInfo, EventData, Status, UsersCosmosDB, SocketData } from './src/utils/types'
import { gogameTurnMode } from './src/turnmode';
import { answerlines, problemlines, INI_REMAINING_HIGHORLOW, generateStartGameInfo, emitStateAllRoomMember, getRandomInt } from './src/gameLogic';
...
async function main() {
    ...
    io.on('connection', function (socket) {
        ...
        gogameTurnMode(io, socket, usersCosmos, gameInfos, lock, container);
        ...
        socket.on('gogameInfiniteMode', function (data: GoGameData) {
            ...
            emitStateAllRoomMember(INFINITROOM, io, gameInfos);
        });
        //ホバー
